export const API_PATHS = {
  ...
  CREDIT_TRANSFERS_QUERY: 'national/creditTransactionsManagement/queryTransfers',
  CREDIT_RETIREMENT_QUERY: 'national/creditTransactionsManagement/queryRetirements',
  TRANSFER_ORGANIZATIONS: 'national/organisation/getOrganizations',
  CB_RETIRE_COINTRY_QUERY: 'national/organisation/countries',
  CREDIT_RETIREMENT_REQUEST: 'national/creditTransactionsManagement/retireRequest',
  CREDIT_RETIREMENT_PERFROM: 'national/creditTransactionsManagement/performRetireAction',
