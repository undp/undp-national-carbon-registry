export const API_PATHS = {
  ...
  RESET_PW: (requestId: string) => `national/auth/resetPassword?requestId=${requestId}`,
  ...
  GET_PROJECT: 'national/programmeSl/query',
  ...
  //CARBON_NEUTRAL
  ISSURE_CARBON_NEUTRAL_CERTIFICATE: 'national/programmeSl/issueCarbonNeutralCertificate',
  ...
  //DOCUMENT
  ADD_DOCUMENT: 'national/document/add',
  //TRANSFER
  ...
  PROJECT_HISTORY_LOGS: (id: string) => `programmeSl/logs?refId=${id}`,
