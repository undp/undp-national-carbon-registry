...
import { DataResponseDto } from "src/shared/src/dto/data.response.dto";
...
import { DocumentEntity } from "src/shared/src/entities/document.entity";
import { User } from "src/shared/src/entities/user.entity";
import { VerificationRequestEntity } from "src/shared/src/entities/verification.request.entity";
import { CompanyRole } from "src/shared/src/enum/company.role.enum";
import { DocumentStatus } from "src/shared/src/enum/document.status";
import { DocumentTypeEnum } from "src/shared/src/enum/document.type.enum";
import { VerificationRequestStatusEnum } from "src/shared/src/enum/verification.request.status.enum";
...
import { ProgrammeAuditLogType } from "src/shared/src/enum/programmeAuditLogType.enum";
