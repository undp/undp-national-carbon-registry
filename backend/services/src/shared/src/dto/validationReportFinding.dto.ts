...
import { ValidationReportConclusion } from "src/shared/src/enum/validationReportConclusion.enum";
import { ValidationReportTypeOfFinding } from "src/shared/src/enum/validationReportTypeOfFinding.enum";
